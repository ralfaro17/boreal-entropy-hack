...
def get_demo_dataset():
    ...
    messages = [
        ...
        models.Message(
            ...
            content="Hi Sarah, quick heads-up that your personal loan payment of $367.82 is scheduled for auto-debit on the 15th.",
        ...
        models.Message(
            ...
            content="Thanks! Auto-debit account is loaded and ready to go.",
        ...
        models.Message(
            ...
            role=models.MessageRole.ASSISTANT,
            content="Hi David, hope you're having a good week. You have an upcoming personal loan installment of $365.12 due soon. Would you like to review payment options or keep your current schedule?",
        ...
        models.Message(
            ...
            conversation_id=make_id("convo_david"),
            role=models.MessageRole.USER,
            content="Can I adjust the due date by a few days? My paycheck deposits on Friday.",
        ...
        models.Message(
            ...
            conversation_id=make_id("convo_david"),
            role=models.MessageRole.ASSISTANT,
            content="Absolutely! We can look at adjusting your billing cycle date so it aligns cleanly with your pay schedule. Would you like me to connect you with a specialist to finalize that date change?",
        ...
        models.Message(
            ...
            role=models.MessageRole.ASSISTANT,
            content="Hi Michael, we noticed your auto loan payment is past due. We're here to help you get back on track. What's the best way for us to support you with this installment?",
        ...
        models.Message(
            ...
            conversation_id=make_id("convo_michael"),
            role=models.MessageRole.USER,
            content="I had unexpected family medical expenses this month. I'm waiting on my next paycheck.",
        ...
        models.Message(
            ...
            conversation_id=make_id("convo_michael"),
            role=models.MessageRole.ASSISTANT,
            content="Thank you for sharing that, Michael, and I hope your family is doing better. We understand unexpected emergencies happen. Would you like to explore a temporary payment plan or split payment?",
        ...
        models.Message(
            ...
            role=models.MessageRole.USER,
            content="I was laid off from my job last week and I don't know how I will make my next payment.",
        ...
        models.Message(
            ...
            conversation_id=make_id("convo_helen"),
            role=models.MessageRole.ASSISTANT,
            content="I hear you, and I want to make sure you get real help with this — connecting you with someone on our team now.",
